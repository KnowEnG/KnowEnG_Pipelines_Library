...
def run_geneset_characterization_pipeline(run_parameters):
    ...
    user_spreadsheet_val_chked, error_msg = check_input_value_for_geneset_characterizationa(user_spreadsheet_df, phenotype_df, run_parameters)
...
def run_gene_priorization_pipeline(run_parameters):
    ...
    user_spreadsheet_val_chked, error_msg = check_input_value_for_gene_prioritazion(user_spreadsheet_df, phenotype_df, run_parameters)
...
def check_input_value_for_geneset_characterizationa(data_frame, phenotype_df, run_parameters):
    """
